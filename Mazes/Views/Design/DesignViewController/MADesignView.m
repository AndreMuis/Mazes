...
@interface MADesignView ()

@property (readonly, strong, nonatomic) id<MADesignViewDelegate> maDesignViewDelegate;
...
{
    _maDesignViewDelegate = delegate;
}
...
- (void)viewTapped: (UITapGestureRecognizer *)recognizer
{
    ...
    if (hitTestResults.count >= 1)
    {
        ...
        if ([firstResult.node isMemberOfClass: [MAWallNode class]] == YES)
        {
            ...
            [self.maDesignViewDelegate designView: self
